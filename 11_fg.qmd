...
You can download GADM data for French Guiana from <https://gadm.org/download_country.html>.
...
Starting from the biomass map of @fayad2016, we can compute a semi-variogram to help choose the resolution of interest. We can already see \>50% variation above 10-km, but for test purposes we will test with \>65% variation with a 20-km grid.
...
We can select a small area with varying biomass based on @fayad2016 map. If we aim for a grid size of 20 km by 20 km, we can limit our test to a 400 simulations, covering an area of 20 x 20 = 400 km or approximatively 0.4°.
